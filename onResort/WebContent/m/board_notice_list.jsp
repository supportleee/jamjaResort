...
<body>
	...
	<div class="container">
		...
		<div class='row'>
			<div class='col-md-12'>
				<%
					NoticeService noticeService = new NoticeServiceImpl(); // service를 사용하기 위해 선언
					List<NoticeDto> notices = noticeService.selectAll(); // 모든 값 select해오기
				...
				<table class="table table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<td class='title'><a href="board_notice_view.jsp?key=<%=item.getId()%>"><%=replaced_title%> 
						<%
					...
					%>
					<%
						// 세션 체크해서 있으면 관리자가 글을 추가할 수 있도록 버튼 보이기
						String loginOK = null;
					...
					%>
					<tr>
						<td id='button_cell' colspan='4' style='text-align: right'><input type='button' value='신규' class="btn btn-outline-primary" onclick="location.href='board_notice_insert.jsp'"></td>
					</tr>
					<%
						}
					%>
