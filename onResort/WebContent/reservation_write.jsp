			...
			<div class='col-md-12 mb-4'>
				<%
					try {
						...
						String addr_before_encoded = request.getParameter("addr");
						String addr_after_encoded = new String(addr_before_encoded.getBytes("8859_1"), "utf-8");
						...
						ReservationDto dto = new ReservationDto(name_after_encoded, date, Integer.parseInt(room),
								addr_after_encoded, telnum, in_name_after_encoded, comment_after_encoded);
