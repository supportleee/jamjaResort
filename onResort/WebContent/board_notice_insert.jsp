	...
	<div class="container">
		...
		<div class='row'>
			<div class='col-md-12'>
				...
				<form method='post' action='board_notice_write.jsp' enctype='multipart/form-data' name='form' onsubmit='return fileCheck(document.form.file);'>
					<table class='table'>
						<tr>
						...
						<tr>
							<td colspan='2' id='button' style='text-align: right'><input class="btn btn-outline-dark" type='button' value='취소' onclick="location.href='board_notice_list.jsp'"> <input class="btn btn-outline-primary" type='submit' value='쓰기'></td>
						</tr>
					</table>
				</form>
			</div>
